...
export default function SignupPage() {
    ...
    const onSignup = async (e) => {
        ...
        try {
            ...
            toast.success("Signup success! Please check your email to verify.");
            router.push("/login");
        } catch (error) {
                ...
                <div className="w-full max-w-md relative z-10">
                    <div className="rounded-3xl border border-gray-800 bg-gray-900/60 backdrop-blur-xl p-8 sm:p-10 shadow-2xl">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-sm text-gray-400">Enter your details to get started with Calorie Lens.</p>
                        </div>

                        <form onSubmit={onSignup} className="space-y-5">
                            <div>
                                <label htmlFor="name" className="block text-sm font-medium mb-1.5 text-gray-300">Full Name</label>
                                <input 
                            ...
                            <button
                                ...
                                disabled={loading || !user.email || !user.password || !user.name}
                            >
                                {loading ? (
                                    <>
